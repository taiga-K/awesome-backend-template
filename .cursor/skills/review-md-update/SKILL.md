...
5. バックエンド API に不要な章は削除し、必要なら API 向け表現へ置き換える
6. 参照情報が必要なら、関連資料への Markdown リンクを `REVIEW.md` に追加する
7. 更新後に全体を読み返し、見出し番号、表現の重複、テンプレートの残骸がないか確認する
8. 可能なら `REVIEW.md` の lint を確認する
