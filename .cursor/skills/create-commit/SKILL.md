---
name: create-commit
description: Generate commit messages following Conventional Commits (scope required, Japanese subject and body). Use when committing changes, writing commit messages, or when the user asks to create commits. Analyzes git diff and commits in logical minimum units.
---
